...
struct ContentView: View {
    ...
    func addNewWord(){
        ...
        guard isOriginal(word: answer) else {
            wordError(title: "Word used", message: "Use a different word!")
            return
        }
        
        guard isPossible(word: answer) else {
            wordError(title: "Word is not possible", message: "'\(rootWord)' not found in your word")
            return
        }
        
        guard isReal(word: answer) else {
            wordError(title: "Word does not exists", message: "???")
            return
        }
